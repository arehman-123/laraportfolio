...
<html class="no-js" lang="en">
    ...
    <body>
       ...
       @include('frontend.pages.components.header')
        <!-- main-area -->
        <main>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget__address">
                                ...
                                <a href="/cdn-cgi/l/email-protection#2d43425f485d41546d48435b4c5942034e4240" class="mail"><span class="__cf_email__" data-cfemail="afc1c0ddcadfc3d6efcac1d9cedbc081ccc0c2">[email&#160;protected]</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6">
        ...
        @include('frontend.pages.components.footer')
